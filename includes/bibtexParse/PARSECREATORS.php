...
//////////////////// PARSEEDITORS to change surname, firstname to firstname surname
    ...
    function parse($input) {
        ...
        foreach($authorArray as $value) {
            ...
            if(strlen($firstname) > 1){
                if($secname != ""){
                    $firstname = substr($firstname,0,1).'.' . ' ' . substr($secname,0,1).'.';
                    $initials ="";
                }
                else{
            ...
            $creators[] = array("$surname", "$initials", "$firstname", "$prefix");
        }
        if( isset( $creators ) ) {
            return $creators;
        }
...
///////////////////////// PARSECREATORS for frontend display/parsing, not for db/importing

class PARSECREATORS1 {
