...
//add tags function as action
add_action('tptags', 'get_pub_tag_list');
...
function tp_add_menu2()
{
    ...
    $tp_admin_add_pub_page      = add_submenu_page('publications.php', __('Add new / Edit', 'teachpress'), __('Add new / Edit', 'teachpress'), 'use_teachpress', 'teachpress/addpublications.php', 'tp_add_publication_page');
